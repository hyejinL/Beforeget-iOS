...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let boxActiveBook = ImageAsset(name: "boxActiveBook")
    ...
    internal static let boxBook = ImageAsset(name: "boxBook")
    ...
    internal static let boxInactiveBook = ImageAsset(name: "boxInactiveBook")
    internal static let boxInactiveMovie = ImageAsset(name: "boxInactiveMovie")
    internal static let boxInactiveMusic = ImageAsset(name: "boxInactiveMusic")
    ...
    internal static let boxInactiveTv = ImageAsset(name: "boxInactiveTv")
    internal static let boxInactiveWebtoon = ImageAsset(name: "boxInactiveWebtoon")
    internal static let boxInactiveYoutube = ImageAsset(name: "boxInactiveYoutube")

...
internal enum FontFamily {
  internal enum PPNeueMachina {
    internal static let regular = FontConvertible(name: "PPNeueMachina-Regular", family: "PP Neue Machina", path: "PPNeueMachina-Regular.otf")
    internal static let ultrabold = FontConvertible(name: "PPNeueMachina-Ultrabold", family: "PP Neue Machina", path: "PPNeueMachina-Ultrabold.otf")
    internal static let all: [FontConvertible] = [regular, ultrabold]
  }
  ...
  internal static let allCustomFonts: [FontConvertible] = [PPNeueMachina.all, Pretendard.all].flatMap { $0 }
